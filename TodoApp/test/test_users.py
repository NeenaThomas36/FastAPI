...
def test_return_user(test_user):
    ...
    assert response.json()['username'] =='ninacodes'
    assert response.json()['email'] =='nina@gmail.com'
    assert response.json()['first_name'] =='nina'
    assert response.json()['last_name'] =='baby'
