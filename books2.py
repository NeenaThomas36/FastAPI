    ...
    model_config = {
        "json_schema_extra": {
            "example": {
                ...
                "description": "A great book for software developers",
                "rating": 5,
                "published_date": 2029 # type: ignore
            }
        }
    }
...
BOOKS =[
    Book(1,"Computer Science Pro","codingwithroby","Good one",5,2030),
    Book(2,"The Science of Programming","David Gries","Welldone",4,2000),
    Book(3,"Introduction to Algorithms","Thomas H. Cormen","Excellent",5,2024),
    Book(4,"Clean Code","Robert C. Martin","Must Read",2,2022),
    Book(5,"The Pragmatic Programmer","Andrew Hunt","Very Good",3,2021),
    Book(6,"Design Patterns","Erich Gamma","Informative",1,2025)
